...
#
# Script generated by Vivado on Thu Mar 05 17:01:45 -0500 2026
...
#
# Usage        : rom1kx8.sh
#                rom1kx8.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rom1kx8.sh [-reset_run]
#                rom1kx8.sh [-reset_log]
#                rom1kx8.sh [-help]
#
...
#                script (type 'rom1kx8.sh -help' for more information).
#
...
# script info
echo -e "rom1kx8.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rom1kx8.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rom1kx8 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.rom1kx8 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log rom1kx8_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: rom1kx8.sh [-step]\n\
Usage: rom1kx8.sh [-lib_map_path]\n\
Usage: rom1kx8.sh [-reset_run]\n\
Usage: rom1kx8.sh [-reset_log]\n\
Usage: rom1kx8.sh [-keep_index]\n\
